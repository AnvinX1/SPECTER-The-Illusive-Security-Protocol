...
16 skills installed covering: governance, recon, threat modeling, code review, API security, web config, cloud, containers, network, supply chain, CI/CD, identity/AD, exploit validation, mobile, and reporting.
